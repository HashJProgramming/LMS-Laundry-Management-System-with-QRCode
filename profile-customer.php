    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/profile.png" width="160" height="160">
                                    <div class="mb-3"></div><strong>Customer</strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8">
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                ...
                                                <div class="mb-3"><label class="form-label" for="last_name"><strong>Contact</strong></label><input class="form-control" type="text" id="last_name-2" placeholder="Contact" name="address"></div>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Customer Transaction</h3>
